...
from genesis._headless import HeadlessRecorderManager, HeadlessVisualizer
...
class Scene(RBC):
    ...
    def __init__(
        ...
        # visualizer
        self._visualizer = HeadlessVisualizer(
            scene=self,
        ...
        # recorders
        self._recorder_manager = HeadlessRecorderManager(self._sim.dt)
